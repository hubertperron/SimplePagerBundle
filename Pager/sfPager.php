...
namespace Ideato\SimplePagerBundle\Pager;
...
abstract class sfPager implements \Iterator, \Countable
{
   ...
   */
  public function __construct(sfParameterHolder $parameter_holder, $maxPerPage = 10)
  {
    $this->setMaxPerPage($maxPerPage);
    $this->parameterHolder = $parameter_holder;
  }
